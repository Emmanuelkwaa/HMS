...
namespace HMS.Areas.Staff.Controllers
{
    ...
    public class DoctorController : ControllerBase
    {
        ...
        {
            var listOfDoctors = await _unitOfWork.Doctor.GetAllAsync(includeProperties:"Department,Address");
        ...
        {
            var doctor = await _unitOfWork.Doctor.GetFirstOrDefaultAsync(p => p.Id == doctorId, includeProperties: "Patients,Department");
        ...
        public async Task<IActionResult> UpdateDoctor(int doctorId, [FromBody] DoctorUpdateDTO doctorUpdateDto)
        {
            ...
            if (!_unitOfWork.Doctor.UpdateDoctor(doctor))
            {
